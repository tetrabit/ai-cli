...
AI_CLI_UPDATE_TOOLS=(claude gh_cli copilot gemini codex hermes)
...
do_setup() {
    ...
    echo "Choose which tools ai-cli should include by default."
    echo "Config: $config"
    echo ""
    ...
    echo -e "${CYAN}Update checks used by 'ai update':${NC}"
